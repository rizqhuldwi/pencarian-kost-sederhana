...
$user = mysqli_query($connect_db, "SELECT * FROM penyewaan ORDER BY id DESC LIMIT 1");
...
<body>' .
    ...
    Silahkan hubungi nomor berikut <b>0812-2661-9002</b> untuk melakukan pembayaran dan konfirmasi pemesanan.<br>
